...
1.	Create a class called ``InvalidLocationException``.  See the Java Doc file [here on BlackBoard](https://lyitbb.blackboard.com/bbcswebdav/courses/OOPR_IT603_2023_CL/InvalidLocationException.html). (You may need to login to BB)
